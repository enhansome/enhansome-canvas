...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,540 | 🐛 106 | 📅 2026-09-02

A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,569 | 🐛 25 | 🌐 Python | 📅 2026-09-18.

## Contributing

Please take a quick gander at the [contribution guidelines](https://github.com/raphamorim/awesome-canvas/blob/master/CONTRIBUTING.md) ⭐ 1,863 | 🐛 15 | 🌐 Markdown | 📅 2026-06-14 first.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,986 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-18 particles animations samples
* [PixelCraft](https://github.com/rgab1508/PixelCraft) ⭐ 1,522 | 🐛 17 | 🌐 JavaScript | 📅 2025-03-16 • A pixel-art editor made using canvas
* [Trigonoparty!](https://ramesaliyev.com/trigonoparty) \[[show me the code](https://github.com/ramesaliyev/trigonoparty) ⭐ 500 | 🐛 6 | 🌐 JavaScript | 📅 2020-01-14] • Simple trigonometry visualisation.
* [Distance Field Waves](http://www.kevs3d.co.uk/dev/shaders/distancefield3.html) \[[show me the code](https://github.com/kevinroast/webglshaders/blob/master/distancefield3.html) ⭐ 213 | 🐛 0 | 🌐 HTML | 📅 2020-02-22] • A example about GPU rendering shader experiments with procedural 3D scene generation using ray marching and distance field (also known as 'sphere tracing') rendering techniques.
* [Cloth Effect](http://raphamorim.io/canvas-experiments/cloth) \[[show me the code](https://github.com/raphamorim/canvas-experiments) ⭐ 50 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-10] • A cloth 3D effect fork.
* [Colorful Particles](http://raphamorim.io/canvas-experiments/particles) \[[show me the code](https://github.com/raphamorim/canvas-experiments) ⭐ 50 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-10] • Experiment show how to generates random particles. Very simple code for assimilate.
* [Draw Table](http://raphamorim.io/canvas-experiments/draw) - \[[show me the code](https://github.com/raphamorim/canvas-experiments) ⭐ 50 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-10] • A simple example about events using canvas.
* [Inception](http://raphamorim.io/canvas-experiments/inception) \[[show me the code](https://github.com/raphamorim/canvas-experiments) ⭐ 50 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-10] • Generates a scrawl of a city, a canvas HTML5 experiment. Based on Inception movie
* [Raining Day](http://raphamorim.io/raining-day/) \[[show me the code](https://github.com/raphamorim/canvas-experiments) ⭐ 50 | 🐛 0 | 🌐 JavaScript | 📅 2017-10-10] • Raindrops using canvas. It's Neatnait Canvas Rain fork.
* [Matrix Animation](https://matrix.dotglitch.dev/) \[[show me the code](https://github.com/knackstedt/matrix-animation) ⭐ 17 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-08] • A Matrix Rain animation using canvas.
* [Just Canvas](http://raphamorim.io/just-canvas/) \[[show me the code](https://github.com/raphamorim/just-canvas) ⭐ 14 | 🐛 2 | 🌐 JavaScript | 📅 2015-05-30]• This is a JavaScript experiment to capture movements. Just Dance Idea + HTML5 Canvas Implementation.
* [Star Time Lapse Effect](https://fralonra.github.io/star-time-lapse/demo/) \[[show me the code](https://github.com/fralonra/star-time-lapse) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2019-11-17] • An example about creating a star time-lapse sky using canvas.
...
* [d3](https://github.com/d3/d3) ⭐ 113,744 | 🐛 19 | 🌐 Shell | 📅 2026-05-28 (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,703 | 🐛 582 | 🌐 JavaScript | 📅 2026-09-14 is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,078 | 🐛 430 | 🌐 JavaScript | 📅 2024-07-23 - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [Konva](https://github.com/konvajs/konva) ⭐ 14,804 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [zDog](https://github.com/metafizzy/zdog) ⭐ 10,661 | 🐛 55 | 🌐 JavaScript | 📅 2023-07-18 - Flat, round, designer-friendly pseudo-3D engine for canvas & SVG
* [zrender](https://github.com/ecomfe/zrender) ⭐ 6,307 | 🐛 374 | 🌐 TypeScript | 📅 2026-09-06 - A lightweight canvas library which providing 2d draw for Apache ECharts (incubating)
...
* [Proton](https://github.com/a-jie/Proton) ⭐ 2,476 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-06 is a lightweight and powerful javascript particle engine. With it you can easily create countless cool effects
...
* [textmode.js](https://github.com/humanbydefinition/textmode.js) ⭐ 170 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 is a lightweight, framework-agnostic creative coding library for real-time ASCII and textmode graphics in the browser.
...
* [React Canvas](https://github.com/Flipboard/react-canvas) ⭐ 13,195 | 🐛 79 | 🌐 JavaScript | 📅 2022-09-27 - High performance <canvas> rendering for React components.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 115,637 | 🐛 384 | 🌐 JavaScript | 📅 2026-09-18
