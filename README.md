...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,358 | 🐛 21 | 🌐 Python | 📅 2026-09-22.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-22 particles animations samples
...
* [d3](https://github.com/d3/d3) ⭐ 113,759 | 🐛 19 | 🌐 Shell | 📅 2026-05-28 (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,712 | 🐛 583 | 🌐 JavaScript | 📅 2026-09-14 is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,816 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-19 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
...
* [textmode.js](https://github.com/humanbydefinition/textmode.js) ⭐ 170 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 is a lightweight, framework-agnostic creative coding library for real-time ASCII and textmode graphics in the browser.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 115,771 | 🐛 379 | 🌐 JavaScript | 📅 2026-09-22
