...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,476 | 🐛 107 | 📅 2026-09-02

A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 323,018 | 🐛 20 | 🌐 Python | 📅 2026-09-25.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,985 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-25 particles animations samples
...
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,719 | 🐛 587 | 🌐 JavaScript | 📅 2026-09-14 is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,829 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
...
* [textmode.js](https://github.com/humanbydefinition/textmode.js) ⭐ 171 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-25 is a lightweight, framework-agnostic creative coding library for real-time ASCII and textmode graphics in the browser.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 115,905 | 🐛 376 | 🌐 JavaScript | 📅 2026-09-25
