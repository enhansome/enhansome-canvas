...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 496,567 | 🐛 100 | 📅 2026-06-30

A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 314,321 | 🐛 16 | 🌐 Python | 📅 2026-08-16.

## Contributing

Please take a quick gander at the [contribution guidelines](https://github.com/raphamorim/awesome-canvas/blob/master/CONTRIBUTING.md) ⭐ 1,854 | 🐛 12 | 🌐 Markdown | 📅 2026-06-14 first.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,954 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 particles animations samples
* [PixelCraft](https://github.com/rgab1508/PixelCraft) ⭐ 1,506 | 🐛 17 | 🌐 JavaScript | 📅 2025-03-16 • A pixel-art editor made using canvas
...
* [Matrix Animation](https://matrix.dotglitch.dev/) \[[show me the code](https://github.com/knackstedt/matrix-animation) ⭐ 16 | 🐛 0 | 🌐 TypeScript | 📅 2026-06-08] • A Matrix Rain animation using canvas.
...
* [d3](https://github.com/d3/d3) ⭐ 113,480 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,645 | 🐛 579 | 🌐 JavaScript | 📅 2026-05-27 is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,063 | 🐛 429 | 🌐 JavaScript | 📅 2024-07-23 - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [Konva](https://github.com/konvajs/konva) ⭐ 14,688 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-15 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
...
* [Sketch](https://github.com/soulwire/sketch.js) ⭐ 4,124 | 🐛 38 | 🌐 JavaScript | 📅 2023-09-16 - Cross-Platform JavaScript Creative Coding Framework
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 114,561 | 🐛 368 | 🌐 JavaScript | 📅 2026-08-16
* [@soulwire](https://twitter.com/soulwire) - Creator of [sketch.js](https://github.com/soulwire/sketch.js) ⭐ 4,124 | 🐛 38 | 🌐 JavaScript | 📅 2023-09-16 and actively creating and sharing canvas/WebGL experiments
