...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,473 | 🐛 106 | 📅 2026-09-02

A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 322,584 | 🐛 21 | 🌐 Python | 📅 2026-09-23.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,986 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-23 particles animations samples
...
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,718 | 🐛 583 | 🌐 JavaScript | 📅 2026-09-14 is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,076 | 🐛 430 | 🌐 JavaScript | 📅 2024-07-23 - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [Konva](https://github.com/konvajs/konva) ⭐ 14,818 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-23 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
...
* [textmode.js](https://github.com/humanbydefinition/textmode.js) ⭐ 170 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-22 is a lightweight, framework-agnostic creative coding library for real-time ASCII and textmode graphics in the browser.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 115,812 | 🐛 382 | 🌐 JavaScript | 📅 2026-09-24
