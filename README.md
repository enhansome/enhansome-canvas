...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 320,890 | 🐛 18 | 🌐 Python | 📅 2026-09-15.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,982 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-15 particles animations samples
* [PixelCraft](https://github.com/rgab1508/PixelCraft) ⭐ 1,520 | 🐛 17 | 🌐 JavaScript | 📅 2025-03-16 • A pixel-art editor made using canvas
...
* [d3](https://github.com/d3/d3) ⭐ 113,732 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,794 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [zDog](https://github.com/metafizzy/zdog) ⭐ 10,656 | 🐛 55 | 🌐 JavaScript | 📅 2023-07-18 - Flat, round, designer-friendly pseudo-3D engine for canvas & SVG
* [zrender](https://github.com/ecomfe/zrender) ⭐ 6,306 | 🐛 373 | 🌐 TypeScript | 📅 2026-09-06 - A lightweight canvas library which providing 2d draw for Apache ECharts (incubating)
...
* [textmode.js](https://github.com/humanbydefinition/textmode.js) ⭐ 165 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 is a lightweight, framework-agnostic creative coding library for real-time ASCII and textmode graphics in the browser.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 115,570 | 🐛 382 | 🌐 JavaScript | 📅 2026-09-15
