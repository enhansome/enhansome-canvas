...
A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 318,068 | 🐛 19 | 🌐 Python | 📅 2026-09-01.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,973 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-02 particles animations samples
...
* [d3](https://github.com/d3/d3) ⭐ 113,614 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,678 | 🐛 588 | 🌐 JavaScript | 📅 2026-05-27 is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
...
* [Konva](https://github.com/konvajs/konva) ⭐ 14,748 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-03 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
...
* [React Canvas](https://github.com/Flipboard/react-canvas) ⭐ 13,200 | 🐛 79 | 🌐 JavaScript | 📅 2022-09-27 - High performance <canvas> rendering for React components.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 115,085 | 🐛 382 | 🌐 JavaScript | 📅 2026-09-03
