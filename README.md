...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,797 | 🐛 106 | 📅 2026-09-02

A curated list of awesome Canvas examples, related articles and posts. Inspired by [awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,113 | 🐛 19 | 🌐 Python | 📅 2026-09-15.
...
* [tsParticles examples](https://codepen.io/tv/DPOage) Collection of [tsParticles](https://github.com/matteobruni/tsparticles) ⭐ 8,983 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-16 particles animations samples
...
* [d3](https://github.com/d3/d3) ⭐ 113,737 | 🐛 20 | 🌐 Shell | 📅 2026-05-28 (or D3.js) is a JavaScript library for visualizing data using web standards. D3 helps you bring data to life using SVG, Canvas and HTML.
* [Chart.js](https://github.com/chartjs/Chart.js) ⭐ 67,696 | 🐛 579 | 🌐 JavaScript | 📅 2026-09-14 is a lightweight JavaScript library for creating dynamic and visually appealing charts using the HTML5 Canvas element.
* [Paper.js](https://github.com/paperjs/paper.js) ⭐ 15,077 | 🐛 430 | 🌐 JavaScript | 📅 2024-07-23 - Scriptographer ported to JavaScript and the browser, using HTML5 Canvas.
* [Konva](https://github.com/konvajs/konva) ⭐ 14,795 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-13 - Konva.js is an HTML5 Canvas JavaScript framework that extends the 2d context by enabling canvas interactivity for desktop and mobile applications.
* [zDog](https://github.com/metafizzy/zdog) ⭐ 10,660 | 🐛 55 | 🌐 JavaScript | 📅 2023-07-18 - Flat, round, designer-friendly pseudo-3D engine for canvas & SVG
* [zrender](https://github.com/ecomfe/zrender) ⭐ 6,306 | 🐛 374 | 🌐 TypeScript | 📅 2026-09-06 - A lightweight canvas library which providing 2d draw for Apache ECharts (incubating)
...
* [textmode.js](https://github.com/humanbydefinition/textmode.js) ⭐ 168 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14 is a lightweight, framework-agnostic creative coding library for real-time ASCII and textmode graphics in the browser.
...
* [@mrdoob](https://twitter.com/mrdoob) - Creator of [three.js](https://github.com/mrdoob/three.js) ⭐ 115,591 | 🐛 385 | 🌐 JavaScript | 📅 2026-09-16
